...
export class CompanySettingsComponent implements OnInit {
  ...
  getSettingsData(){
    ...
    this.service.getCompanySettingsData(options).subscribe(response => {
      this.setttingsForm = this._fb.group({
  ...
  submitCompanySettings() {
    if (this.setttingsForm.valid) {
      ...
      this.service.postCompanySettingsData(this.setttingsForm.value,options).subscribe(response => {
